package com.pokepok.rest.resource;
...
import com.pokepok.rest.entity.HttpResponse;
import com.pokepok.rest.entity.User;
import com.pokepok.rest.entity.UserPrincipal;
import com.pokepok.rest.exception.domaine.*;
import com.pokepok.rest.service.UserService;
import com.pokepok.rest.utility.JWTTokenProvider;

import static com.pokepok.rest.constant.FileConstant.*;
import static com.pokepok.rest.constant.SecurityConstant.*;
...
//herite d'exceptionhandling pour géré si le user est deja utiliser
	...
	public ResponseEntity<User> update(
		...
		User updateUser = userService.updateUser(username, firstName, lastName, currentUsername, email, role, Boolean.parseBoolean(isActive), Boolean.parseBoolean(isNonLocked), profileImage);
