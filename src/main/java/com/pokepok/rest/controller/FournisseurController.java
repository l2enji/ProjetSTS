...
import com.pokepok.rest.entity.Fournisseur;
import com.pokepok.rest.service.impl.FournisseurServiceImpl;
...
public class FournisseurController {
	...
	public ResponseEntity deleteProduitAppro( @PathVariable(name="id")Long idFournisseur) {
		Fournisseur fournisseur = fournisseurServiceImpl.getFournisseurById(idFournisseur);
		if(idFournisseur==null) {
			return ResponseEntity.notFound().build();
		}
